...
uint8_t *Messages[6] = {"Led1 is on","Led2 is on ","Button1 Pressed","Button2 Pressed","OFF        ","                "};
...
void Led_Task(void *pvParameters)
{
    ...
    while(1)
    {
        ...
        else if( ( uxBits & BIT_4 ) != 0 && (uxBits & BIT_0) == 0)
        {
            Led1_Switch(LED1_ON);
        }
        else
...
void Lcd_Task(void *pvParameters)
{
    ...
    while(1)
    {
        ...
        {
            //LCD_Clear();
            LCD_sendString_RowCol(Messages[4],1,1);
            LCD_sendString_RowCol(Messages[5],2,1);
        }
